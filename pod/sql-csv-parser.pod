...
B<sql-csv-parser> --sql-statement <SQL-statment> [--file <file.csv|directory>] [--csv-sep-char <delimiter>]
	...
	sql-csv-parser --sql-statement 'SELECT * FROM file.csv' --file ./file.csv \
		| while IFS="	" read col1 col2 _; do :; done
...
The Results are print (a dump) to STDOUT, separated by I<--lsep> wich defaults to I<\n>. The option I<--fsep> defaults to I<\t> and I<--maxlen> defaults to I<256>.
